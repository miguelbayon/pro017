...
El precio del alquiler a pagar se calcula a partir del número de días de ocupación  multiplicado por un valor en función del  barco (esta valor es el resultante de multiplicar por 10 los metros de eslora). Al resultado se le suma la cantidad obtenida de sumar un valor ﬁjo (300 euros) multiplicado por el _coeficiente de Bernua_ del barco. 
