...
Para cada alquiler de un amarre se guarda el nombre y DNI del cliente, el numero de días de alquiler, la posición del amarre (0, 1, 2 o 3) y el barco que lo ocupará. 
