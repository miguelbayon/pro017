...
El método que se utiliza para preguntar cosas a la persona debe llamarse `responder`, admite un único parámetro y debe devolver la respuesta además de imprimirla por pantalla.
