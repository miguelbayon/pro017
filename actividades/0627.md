...
2. Implementa un método en la red social llamado `mostrarDatosExclusivosEntradasFiltradas` que imprima por pantalla los datos exclusivos de los post filtrados.  La invocación a dicho método sería del tipo:
