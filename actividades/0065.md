...
1. A partir del código terminado de la actividad 0704, implementa un nuevo método en la clase `StockManager` que imprima los detalles de todos los productos cuyo stock está por debajo de un determinado número que será pasado como parámetro al método.
