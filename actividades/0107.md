## 0107 - Modificando el código para crear nuestro propio juego
...
3. Añade la imagen a tu repositorio local del juego y haz un commit (**commit 01**). A partir de ahora, todos los commits que hagas en este proyecto deberán tener al inicio del mensaje el código que se indica (en este caso, "`01.`" seguido de tu mensaje).
